...
/**
 * I18n for the button captions. This class contains the translations for language code 'oc'.
 * 
 * @author Dieter Steinwedel
 */
public class MBResource_oc extends ListResourceBundle {
	...
	protected Object[][] getContents() {
		return new Object[][] {
			{ButtonId.OK.toString(), "Validar"},
			{ButtonId.ABORT.toString(), "Abandonar"},
			{ButtonId.CANCEL.toString(), "Anullar"},
			{ButtonId.YES.toString(), "Òc"},
