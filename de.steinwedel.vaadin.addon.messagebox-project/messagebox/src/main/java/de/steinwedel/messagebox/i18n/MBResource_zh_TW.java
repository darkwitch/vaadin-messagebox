 ...
 */
public class MBResource_zh_TW extends ListResourceBundle {
	...
	protected Object[][] getContents() {
		return new Object[][] {
			{ButtonId.OK.toString(), "確定"},
			{ButtonId.ABORT.toString(), "中止"},
			{ButtonId.CANCEL.toString(), "取消"},
			{ButtonId.YES.toString(), "是"},
			{ButtonId.NO.toString(), "否"},
			{ButtonId.CLOSE.toString(), "關閉"},
			{ButtonId.SAVE.toString(), "儲存"},
			{ButtonId.RETRY.toString(), "重試"},
			{ButtonId.IGNORE.toString(), "忽略"},
			{ButtonId.HELP.toString(), "說明"},
