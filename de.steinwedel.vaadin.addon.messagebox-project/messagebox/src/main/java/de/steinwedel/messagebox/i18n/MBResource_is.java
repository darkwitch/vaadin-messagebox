...
/**
 * I18n for the button captions. This class contains the translations for language code 'is'.
 * 
 * @author Dieter Steinwedel
 */
public class MBResource_is extends ListResourceBundle {
