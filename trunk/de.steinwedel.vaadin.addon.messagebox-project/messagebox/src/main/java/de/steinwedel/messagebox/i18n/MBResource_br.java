...
/**
 * I18n for the button captions. This class contains the translations for language code 'br'.
 * 
 * @author Dieter Steinwedel
 */
public class MBResource_br extends ListResourceBundle {
