...
/**
 * I18n for the button captions. This class contains the translations for language code 'cy'.
 * 
 * @author Dieter Steinwedel
 */
public class MBResource_cy extends ListResourceBundle {
