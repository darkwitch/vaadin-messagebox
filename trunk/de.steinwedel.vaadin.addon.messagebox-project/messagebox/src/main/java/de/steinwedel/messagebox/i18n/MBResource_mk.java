...
/**
 * I18n for the button captions. This class contains the translations for language code 'mk'.
 * 
 * @author Dieter Steinwedel
 */
public class MBResource_mk extends ListResourceBundle {
