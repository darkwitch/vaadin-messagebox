...
/**
 * I18n for the button captions. This class contains the translations for language code 'te'.
 * 
 * @author Dieter Steinwedel
 */
public class MBResource_te extends ListResourceBundle {
