...
public class DemoUI extends UI {
    ...
    public void init(VaadinRequest request) {
        ...
        GridLayout layout = new GridLayout(3,17);
        setContent(layout);
        ...
        customIcons.addClickListener(new ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				MessageBox mb = MessageBox.showPlain(new ClassResource(DemoUI.class, "acme.png"), "Example 16", "Custom icons used!", ButtonId.YES, ButtonId.NO);
        ...
        for (int x = 0; x < layout.getColumns(); x++) {
        	for (int y = 0; y < layout.getRows(); y++) {
        		...
        		System.out.println(layout.getColumns() + "; " + layout.getRows() + "; " + x + "; " + y + "; " + layout.getComponent(x, y));
        		layout.setComponentAlignment(layout.getComponent(x, y), Alignment.MIDDLE_LEFT);
        	}
        }
    }
